...
\begin{tikzpicture}
  ...
  \node[state, name=evaluation1, below of=aspect, right of=aspect, xshift=8em] {Evaluation on Non-prominent Aspects};
  \node[state, name=evaluationp, below of=aspect, left of=aspect, xshift=-8em] {Evaluation on Prominent Aspect};
